...
oarsub -S "$cmd1" -n "VA-mxs-ro-ge-[32 96 64 192]"
oarsub -S "$cmd2" -n "VA-mxs-ro-ge-[32 96 256 384]"
oarsub -S "$cmd3" -n "VA-mxs-ro-ge-[112 176 64 192]"
oarsub -S "$cmd4" -n "VA-mxs-ro-ge-[112 176 256 384]"
