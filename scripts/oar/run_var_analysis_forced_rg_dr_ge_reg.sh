...
oarsub -S "$cmd1" -n "VA-forced-rg-dr-ger-[32 96 64 192]"
oarsub -S "$cmd2" -n "VA-forced-rg-dr-ger-[32 96 256 384]"
oarsub -S "$cmd3" -n "VA-forced-rg-dr-ger-[112 176 64 192]"
oarsub -S "$cmd4" -n "VA-forced-rg-dr-ger-[112 176 256 384]"
