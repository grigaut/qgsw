...
echo Running: \".venv/bin/python3 -u scripts/variational_analysis_enatl60_sst_adv_hr.py $@\"

LD_PRELOAD=./.venv/lib/libstdc++.so.6 .venv/bin/python3 -u scripts/variational_analysis_enatl60_sst_adv_hr.py $@
