...
args = ScriptArgsVA.from_cli(
    ...
    cycles_default=3,
    prefix_default="results_single_alpha",
)
specs = defaults.get()
...
for c in range(n_cycles):
    ...
    register_params_alpha = RegisterParams(alpha=alpha)
    ...
    for o in range(optim_max_step):
        ...
        with torch.enable_grad():
            ...
            model_alpha.alpha = torch.ones_like(model_alpha.psi) * alpha
        ...
        register_params_alpha.step(loss, alpha=alpha)
